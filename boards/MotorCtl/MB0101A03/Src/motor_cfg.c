...
u8 m0_event_read(u8 event_id){return HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_13)==RESET;}
u8 m1_event_read(u8 event_id){return HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_13)==RESET;}
u8 m2_event_read(u8 event_id){return HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_13)==RESET;}
