...
u8 m2_event_read(u8 event_id){return HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_1) == GPIO_PIN_RESET;}
u8 m3_event_read(u8 event_id){return HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_1) == GPIO_PIN_RESET;}
