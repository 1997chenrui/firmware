...
__weak u8 m0_event_read(u8 event_id){return (HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_1)== GPIO_PIN_RESET);}
__weak u8 m1_event_read(u8 event_id){return (HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_1)== GPIO_PIN_RESET);}
