...
u8 m0_event_read(u8 event_id){return !HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_12);}
u8 m1_event_read(u8 event_id){return !HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_12);}
u8 m2_event_read(u8 event_id){return !HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_12);}
