...
extern void motor_rotate_test(u8 idx, u16 time_ms, u8 dir);
...
u8 m0_event_read(u8 event_id){return HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_1) == GPIO_PIN_SET;}
