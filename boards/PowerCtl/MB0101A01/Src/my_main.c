...
static  void  AppTaskStart (void *p_arg)
{
	...
	OSTimeDly(2000);
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_9, GPIO_PIN_SET);//RS232 respond switch 开
	while(1)
    {
		NORMAL_LED_CTRL(0);
        OSTimeDly(500);
//		for(int i = 0 ; i<6;i++)
//		{
//			MS5194T_GetData(&MS5194T[0], MS5194T_map[i]);
//		}
		NORMAL_LED_CTRL(1);
		OSTimeDly(500);
