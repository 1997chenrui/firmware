...
void EventScan0(uint32_t * exflag,uint8_t* inflag)
{
	...
	Update_Servomotor_UserEvent(HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_12)==GPIO_PIN_RESET,3);
	Update_Servomotor_UserEvent(HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_13)==GPIO_PIN_RESET,4);
