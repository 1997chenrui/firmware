...
{
	HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_9);//电机1的到达
	HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_8);//电机1的事件
...
void EXTI15_10_IRQHandler(void)
{
	...
	HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_14);//电机1的零位
...
{
	HAL_GPIO_EXTI_IRQHandler(GPIO_PIN_4);//电机0的零位
}
...
{
	{
	 ...
	 .enc_in_invert_dir=false,//是否反向编码器方向
...
bool TMC4361A_ZeroSwitchStateGet_1(void)
{
	...
	GPIO_PinState rt=(HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_14));
