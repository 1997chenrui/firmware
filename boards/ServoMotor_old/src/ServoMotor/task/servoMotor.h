...
#define ServoMotor_DRIVE_ENC_VLE0 			126
#define ServoMotor_DRIVE_CL_MAX 			127
#define ServoMotor_DRIVE_CL_FIT 			128
...
typedef struct sMotorCfg
{
	...
	float max_distance;//该电机允许的反向最大行程 mm
	float max_distance_reverse;//该电机允许的正向最大的行程 mm
