...
MotorThread MotorThread_OS[MOTOR_CNT];
extern TIM_HandleTypeDef htim4;
SeqQueue_Struct   queue[MOTOR_CNT];        //队列成员应该是命令码和send对象
...
MOTOR_IO_WR_DECLARE(0, GPIOD,GPIO_PIN_4, GPIOD,GPIO_PIN_5, GPIOD,GPIO_PIN_6, GPIOD,GPIO_PIN_0, GPIOD,GPIO_PIN_1);  //cs en em REFL_X  REFR_X
MOTOR_IO_WR_DECLARE(1, GPIOD,GPIO_PIN_12, GPIOD,GPIO_PIN_13, GPIOD,GPIO_PIN_14, GPIOD,GPIO_PIN_10, GPIOD,GPIO_PIN_11);  //cs en em REFL_X  REFR_X
MOTOR_IO_WR_DECLARE(2, GPIOC,GPIO_PIN_10, GPIOC,GPIO_PIN_11, GPIOC,GPIO_PIN_12, GPIOC,GPIO_PIN_8, GPIOC,GPIO_PIN_9);
MOTOR_IO_WR_DECLARE(3, GPIOE,GPIO_PIN_13, GPIOE,GPIO_PIN_14, GPIOE,GPIO_PIN_15, GPIOE,GPIO_PIN_9, GPIOE,GPIO_PIN_12);  //cs en em REFL_X  REFR_X

// Zero, SWP, SWN
MOTOR_IO_RD_DECLARE(0, GPIOB,GPIO_PIN_4, GPIOD,GPIO_PIN_3, GPIOD,GPIO_PIN_2);  //光耦接触到时IO中断  比较位置寄存器IO中断		SWN_X
MOTOR_IO_RD_DECLARE(1, GPIOB,GPIO_PIN_14, GPIOD,GPIO_PIN_9, GPIOD,GPIO_PIN_8);  //光耦接触到时IO中断  比较位置寄存器IO中断		SWN_X
MOTOR_IO_RD_DECLARE(2, GPIOD,GPIO_PIN_15, GPIOC,GPIO_PIN_7, GPIOC,GPIO_PIN_6);
MOTOR_IO_RD_DECLARE(3, GPIOB,GPIO_PIN_12, GPIOE,GPIO_PIN_11, GPIOE,GPIO_PIN_10);  //光耦接触到时IO中断  比较位置寄存器IO中断		SWN_X
...
void MotorInit()
{
    ...
    MOTOR_THRAD_CREATE(2);
    MOTOR_THRAD_CREATE(3);
}

//void TIM4_IRQHandler(void) // 探液面,1KHz
//{
