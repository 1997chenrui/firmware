...
#define     MOTOR_CNT             4  //总电机数目
#define MOTOR_THEARD_CNT    MOTOR_CNT
#define MOTOR_THREAD_STACK_SIZE         512

#define CE_ASSERT( exp ) ce_assert((exp),__LINE__)

#define Motor0Thread_Prio                5
#define Motor1Thread_Prio                6
#define Motor2Thread_Prio                7
#define Motor3Thread_Prio                8


#define  MOTOR_THRAD_CREATE(idx)        \
printf("mot=%d, thread code=%d\r\n",idx, bus_create_thread(&MotorThread_OS[idx].tcb,Motor_Thread,         \
				MotorThread_OS[idx].stack, MOTOR_THREAD_STACK_SIZE, (5+idx),NULL));\
