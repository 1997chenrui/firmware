...
#define TMC5130_MODE_VELPOS    1  //速度模式到正 VMAX (使用 AMAX 加速度)
#define TMC5130_MODE_VELNEG    2  //速度模式到负 VMAX (使用 AMAX 加速度)
#define TMC5130_MODE_HOLD      3  //保持模式(除非发生停止事件，否则速度保持不变)
...
#define R6C 0x000141D5  // CHOPCONF 0x000101D5
...
void mTMC5130DriverMove(struct sTABLE *);
