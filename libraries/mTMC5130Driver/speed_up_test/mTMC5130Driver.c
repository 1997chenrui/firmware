...
void mTMC5130Driver_Init(struct sTABLE *ths)//初始化
{
	...
	SPI_WriteRead(ths,TMC5130_IHOLD_IRUN,SPI_WRITE_TYPE,ths->mTMCDriverReg->IHOLD_IRUN,RxData);
...
//	SPI_WriteRead(ths,TMC5130_PWMCONF, SPI_WRITE_TYPE,0x004C8,RxData);
