...
static void packet_parse(Itf_00010020_t* self, bus_packet* packet);
static void ret_and_free(Itf_00010020_t* self, bus_packet* packet, u8 error_code);

Itf_00010020_t* Itf_00010020_new(void){
    Itf_00010020_t* self = (Itf_00010020_t*)malloc(sizeof(Itf_00010020_t));
    memset(&self->content, 0, sizeof(Itf_00010020_content_t));
