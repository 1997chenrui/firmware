...
static void packet_parse(Itf_00010070_t* self, bus_packet* packet);
static void ret_and_free(Itf_00010070_t* self, bus_packet* packet, u8 error_code, f32 trigger_distance);

Itf_00010070_t* Itf_00010070_new(void){
    Itf_00010070_t* self = (Itf_00010070_t*)malloc(sizeof(Itf_00010070_t));
    memset(&self->content, 0, sizeof(Itf_00010070_content_t));
